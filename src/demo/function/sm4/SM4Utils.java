...
public class SM4Utils
{
	...
	public byte[] encryptData_ECB_BYTE(byte[] plainText)
	{
		try 
		{
			SM4_Context ctx = new SM4_Context();
	...
	public byte[] decryptData_ECB_BYTE(byte[] cipherText)
	{
		try 
		{
			SM4_Context ctx = new SM4_Context();
	...
	{
		String plainText = "ererfeiisgodfdgsdgfdgsdgsdfg";
		//m9QDtGEkOh65iFyV8LXXhupK3D2nLrdnYVxPJc/Stpc=
		SM4Utils sm4 = new SM4Utils();
		sm4.secretKey = "$%$^%$%$%$%$%$%$";  //meF8U9wHFOMfs2Y9
		sm4.hexString = false;
